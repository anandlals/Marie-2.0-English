...
def hack(bot: Bot, update: Update):
    ...
    for x in range(EDIT_TIMES):
        ...
        time.sleep(EDIT_SLEEP)
    msg.edit_text('successful hacked all data send on @EliteDarkRay Database

*Thank you for giving this data* 
By @EliteDarkRay

(if you want the data contact my owner 😁)')
...
def love(bot: Bot, update: Update):
    ...
    for x in range(EDIT_TIMES):
        ...
        time.sleep(EDIT_SLEEP)
    msg.edit_text('True Love 💔 Broken by me')
